                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div id='menu' className="mt-[26rem] lg:mt-0 absolute z-10 lg:z-0 lg:static lg:flex lg:space-x-1 w-[100vw] lg:w-min" hidden>
...

                        {
                            user?( 
                                <div className='flex'>
                                    <div className='border-2 border-white p-1 hover:bg-gray-800 active:bg-gray-700 cursor-pointer rounded-lg text-2xl'>
                                    ...
                                    <div className='border-2 border-white p-1 hover:bg-gray-800 active:bg-gray-700 cursor-pointer rounded-lg text-2xl mx-3'>
                                        <span onClick={()=>dispatch(logout(navigate))}><FiLogOut/></span> 
                                    </div>
                                </div>
                            ):(
                                <div className='border-2 border-white p-1 hover:bg-gray-800 active:bg-gray-700 cursor-pointer rounded-lg text-2xl mx-3'>
